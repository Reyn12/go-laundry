    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 p-2 md:p-4 lg:p-6 mx-2 md:mx-4 lg:mx-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-4 md:p-6 hover:-translate-y-1 transition-all duration-300">
            <div class="flex items-start justify-between mb-3 md:mb-4">
                ...
                <div class="px-2 md:px-3 py-0.5 md:py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full text-xs md:text-sm">
                    Verified
                </div>
            </div>
            ...
            <div class="flex gap-2">
                ...
                <button class="flex-1 bg-green-500 text-white py-2 md:py-2.5 px-3 md:px-4 rounded-xl hover:bg-green-700 transition-colors text-xs md:text-sm">
                    Edit
                </button>
            </div>
        </div>
