{{-- Header Component --}}
<div class="header w-full h-16 flex bg-white dark:bg-gray-800 justify-between items-center px-6 rounded-lg shadow-lg">
    ...
    <div class="right flex items-center space-x-6">
        ...
        <div class="search-bar">
            <div class="relative">
                ...
                <input type="search" class="pl-10 pr-4 py-2 w-64 rounded-full bg-gray-100 dark:bg-gray-700 dark:text-white focus:outline-none" placeholder="Search">
            </div>
        </div>
