    ...
    <div class="grid grid-cols-3 gap-8 p-6 mx-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-[20px] shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-6 hover:-translate-y-1 transition-all duration-300">
            <div class="flex items-start justify-between mb-4">
                ...
                <div class="px-3 py-1 bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 rounded-full text-sm">
                    Pending
                </div>
            </div>
            ...
            <div class="flex gap-2">
                <button class="flex-1 bg-[#0051FF] text-white py-2.5 px-4 rounded-xl hover:bg-blue-700 transition-colors">
                    Terima
                </button>
                <button class="flex-1 bg-red-500 text-white py-2.5 px-4 rounded-xl hover:bg-red-700 transition-colors">
                    Tolak
                </button>
            </div>
        </div>
