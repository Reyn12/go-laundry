...
<div class="relative min-h-[85vh] flex items-center justify-center px-4 lg:px-12 py-6 lg:py-8 bg-black overflow-hidden mx-2 md:mx-8 mt-4 md:mt-8 rounded-[30px] md:rounded-[90px]" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="container mx-auto relative z-10">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-5 md:gap-10">
            ...
            <div class="flex-1 relative h-[400px] md:h-[600px] hidden lg:block">
                ...
                <div class="absolute top-10 left-1/2 -translate-x-1/2 w-36 md:w-44 -ml-10 md:-ml-14 h-auto animate-float-fast" data-aos="fade-down" data-aos-delay="300">
                    <img src="{{ asset('images/bgHero3.svg') }}" alt="Floating 3" class="w-full h-auto rounded-2xl">
                </div>
                <!-- Gambar kanan -->
                <div class="absolute top-40 md:top-60 right-20 w-44 md:w-56 h-auto animate-float-slow" data-aos="fade-left" data-aos-delay="500">
                    <img src="{{ asset('images/bgHero1.svg') }}" alt="Floating 1" class="w-full h-auto rounded-2xl bg-white">
                </div>
                <!-- Gambar kiri -->
                <div class="absolute top-40 -mb-10 left-10 w-40  md:w-48 h-auto animate-float-medium" data-aos="fade-right" data-aos-delay="700">
