<div class="flex flex-col items-center gap-4 px-4 pb-6" data-aos="fade-up" data-aos-duration="1000">
    <div class="flex flex-col items-center w-full max-w-7xl gap-4 p-6 rounded-2xl backdrop-blur-lg shadow-lg" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full place-items-center">
            ...
            <div class="group relative overflow-hidden w-full max-w-[350px] justify-self-center" 
                 data-aos="fade-up" 
                 data-aos-delay="{{ $delay + ($loop->iteration * 200) }}">
                <div class="flex flex-col p-4 rounded-xl bg-gradient-to-br from-gray-800 to-gray-900 hover:from-gray-700 hover:to-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    ...
                    <div class="space-y-3 flex-1">
                        <div class="flex items-start gap-2">
                            <img src="{{ asset('images/icons/iconLocationInformation.svg') }}" alt="" class="w-4 h-4 mt-1">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="flex flex-wrap gap-1.5">
                                ...
                                <span class="px-2 py-0.5 text-xs text-gray-300 bg-gray-700 rounded-full">{{ $durasi }}</span>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        <a href="{{ url('/user/login') }}" class="flex items-center justify-center gap-2 w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-lg font-medium transition-all duration-300 group-hover:shadow-lg">
                            Pilih Laundry
