                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="relative">
                            ...
                            <button 
                                type="button"
                                onclick="getLocation()"
                                class="absolute right-2 top-[50%] -translate-y-1/2 p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg shadow-md transition-all duration-300 flex items-center gap-2 group"
                            >
                                <i class="fas fa-map-marker-alt text-lg group-hover:scale-110 transition-transform"></i>
                                <span class="text-sm font-medium">Pilih di Map</span>
                            </button>
                        </div>
...
<!-- Modal Map -->
<div id="mapModal" class="fixed inset-0 z-[9999] hidden">
    <!-- Backdrop dengan z-index lebih rendah -->
    <div class="fixed inset-0 bg-black bg-opacity-50 z-[9998]" id="mapModalBackdrop"></div>
    
    <!-- Modal content dengan z-index lebih tinggi -->
    <div class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-11/12 max-w-3xl bg-white rounded-lg shadow-lg z-[9999]">
        <div class="p-4">
            <h3 class="text-lg font-semibold mb-4">Pilih Lokasi Laundry</h3>
            <div id="map" class="w-full h-96 rounded-lg mb-4"></div>
            <div class="flex justify-end gap-2">
                <button type="button" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600" onclick="closeModal()">
                    Batal
                </button>
                <button type="button" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" onclick="handleMyLocation()">
                    Lokasi Saya
                </button>
                <button type="button" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600" onclick="handleConfirmLocation()">
                    Pilih Lokasi
                </button>
            </div>
        </div>
